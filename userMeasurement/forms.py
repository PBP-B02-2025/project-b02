...
class UserMeasurementForm(ModelForm):
    class Meta:
        ...
        fields = ['height', 'weight', 'waist', 'hip', 'chest', 'head_circumference']
        widgets = {
            ...
            'head_circumference': forms.NumberInput(attrs={'class': 'w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500'}),
        }
