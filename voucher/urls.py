...
urlpatterns = [
    ...
    path('update-ajax/<int:voucher_id>/', views.update_voucher_ajax, name='update-voucher-ajax'),
    path('delete-ajax/<int:voucher_id>/', views.delete_voucher_ajax, name='delete-voucher-ajax'),
